...
laid out in a 10x6 grid that fits the 1600x1200 window tests/e2e/conftest.py opens.
...
ROW_PITCH = 130  # card height 120px + gap
...
def build_kit():
    ...
    for i in range(1, CARD_COUNT + 1):
        ...
        components[f"C{i:03d}"] = {
            ...
            "height": "120px", "left": f"{col * COLUMN_PITCH}px", "name": f"card{i}",
